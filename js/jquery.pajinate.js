...
(function($) { /*******************************************************************************************/
	...
	$.fn.pajinate = function(options, classname) {
		...
		return this.each(function() {
		    ...
		    if (classname != "") {
		        $items = $page_container.find(options.item_container_id).children('.' + classname);
		    } else {
		    ...
		    if (classname != "") {
                var total_items = $item_container.children('.' + classname).length;
		    } else {
                var total_items = $item_container.children().length;
            }
